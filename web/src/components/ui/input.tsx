    ...
    return (
      <div className="flex flex-col gap-2">
        ...
        <input
          ref={ref}
          id={id}
          // Some password managers and form-fill browser extensions inject
          // `fdprocessedid` / similar attributes on form fields between SSR
          // and hydration, producing noisy "did not match" warnings that
          // are NOT real bugs. Suppress at the field level.
